...
%function downloadData(sub)
   ...
   %i = 0;
    ...
    parameters1 = psychometricFit(x,yMean1,['Average (n = ' num2str(length(pseStore1)) ')'],1,0);
    ...
    parameters2 = psychometricFit(x,yMean2,['Average (n = ' num2str(length(pseStore2)) ')'],2,0);
